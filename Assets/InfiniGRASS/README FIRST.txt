...
The main setup manual can be found in the following link:

------------ Main Setup Manual ------------
https://drive.google.com/drive/folders/1nHQ0Oxpei5OlWEN4T_vAf3T25aYmy1EV?usp=sharing


The photos based manual and reference PDF can be downloaded from the following link:
